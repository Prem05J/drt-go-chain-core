...
func (m *MetaDataVersion) Reset()      { *m = MetaDataVersion{} }
func (*MetaDataVersion) ProtoMessage() {}
func (*MetaDataVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_af4fac0141b37903, []int{3}
}
...
func (m *MetaDataVersion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetaDataVersion.Merge(m, src)
}
func (m *MetaDataVersion) XXX_Size() int {
	return m.Size()
}
func (m *MetaDataVersion) XXX_DiscardUnknown() {
	xxx_messageInfo_MetaDataVersion.DiscardUnknown(m)
}

var xxx_messageInfo_MetaDataVersion proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MetaDataVersion)(nil), "protoBuiltInFunctions.MetaDataVersion")
}
...
var fileDescriptor_af4fac0141b37903 = []byte{
	...
	,
}
...
func (this *MetaDataVersion) Equal(that interface{}) bool {
	...
	that1, ok := that.(*MetaDataVersion)
	if !ok {
		that2, ok := that.(MetaDataVersion)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MetaDataVersion) GoString() string {
	...
	s := make([]string, 0, 10)
	s = append(s, "&dcdt.MetaDataVersion{")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "Creator: "+fmt.Sprintf("%#v", this.Creator)+",\n")
	s = append(s, "Royalties: "+fmt.Sprintf("%#v", this.Royalties)+",\n")
	s = append(s, "Hash: "+fmt.Sprintf("%#v", this.Hash)+",\n")
...
func (m *MetaDataVersion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Attributes != 0 {
		i = encodeVarintDcdt(dAtA, i, uint64(m.Attributes))
		i--
		dAtA[i] = 0x30
	}
	if m.URIs != 0 {
		i = encodeVarintDcdt(dAtA, i, uint64(m.URIs))
		i--
		dAtA[i] = 0x28
	}
	if m.Hash != 0 {
		i = encodeVarintDcdt(dAtA, i, uint64(m.Hash))
		i--
		dAtA[i] = 0x20
	}
	if m.Royalties != 0 {
	...
	if m.Creator != 0 {
		i = encodeVarintDcdt(dAtA, i, uint64(m.Creator))
		i--
		dAtA[i] = 0x10
	}
	if m.Name != 0 {
		i = encodeVarintDcdt(dAtA, i, uint64(m.Name))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MetaDataVersion) Size() (n int) {
	...
	_ = l
	if m.Name != 0 {
		n += 1 + sovDcdt(uint64(m.Name))
	}
	if m.Creator != 0 {
		n += 1 + sovDcdt(uint64(m.Creator))
	}
	if m.Royalties != 0 {
		n += 1 + sovDcdt(uint64(m.Royalties))
	}
	if m.Hash != 0 {
		n += 1 + sovDcdt(uint64(m.Hash))
	}
	if m.URIs != 0 {
		n += 1 + sovDcdt(uint64(m.URIs))
	}
	if m.Attributes != 0 {
		n += 1 + sovDcdt(uint64(m.Attributes))
	}
	return n
}
...
func (this *MetaDataVersion) String() string {
	...
	s := strings.Join([]string{`&MetaDataVersion{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Creator:` + fmt.Sprintf("%v", this.Creator) + `,`,
		`Royalties:` + fmt.Sprintf("%v", this.Royalties) + `,`,
		`Hash:` + fmt.Sprintf("%v", this.Hash) + `,`,
...
func (m *MetaDataVersion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetaDataVersion: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetaDataVersion: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Royalties |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Attributes |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
